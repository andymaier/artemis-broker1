...
ARTEMIS_INSTANCE='/home/andreas/development/predic8_artemis/kurs/broker-1'
ARTEMIS_DATA_DIR='/home/andreas/development/predic8_artemis/kurs/broker-1/data'
ARTEMIS_ETC_DIR='/home/andreas/development/predic8_artemis/kurs/broker-1/etc'
ARTEMIS_OOME_DUMP='/home/andreas/development/predic8_artemis/kurs/broker-1/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/home/andreas/development/predic8_artemis/apache-artemis-2.17.0/../kurs/broker-1/'
ARTEMIS_INSTANCE_ETC_URI='file:/home/andreas/development/predic8_artemis/apache-artemis-2.17.0/../kurs/broker-1/etc/'
...
# Java Opts
if [ -z "$JAVA_ARGS" ]; then
    JAVA_ARGS="-Dbrokerconfig.globalMaxSize=2000000 -XX:+PrintClassHistogram -XX:+UseG1GC -XX:+UseStringDeduplication -Xms512M -Xmx2G -Dhawtio.disableProxy=true -Dhawtio.realm=activemq -Dhawtio.offline=true -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml "
fi
